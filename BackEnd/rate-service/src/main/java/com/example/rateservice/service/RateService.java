...
public class RateService {
    ...
    public Rate addRate(Rate rate) throws JsonProcessingException {
        ...
        Rate rate1 = new Rate();
        // Room room =
        // restTemplate.getForObject("http://room-service.default.svc.cluster.local:8088/room/{roomId}",
        ...
        // restTemplate.put("http://room-service.default.svc.cluster.local:8088/room/",
        // roomString, String.class);
